...
const tld = ".karma";
const CONTRACT_ADDRESS = '0xbf64e4356c8fAE5B9D0EC7A189b02fDA00BC4726';
	...
	const mintDomain = async () => {
		...
		try {
			...
			if (ethereum) {
				...
				if (receipt.status === 1) {https://img.icons8.com/metro/26/000000/pencil.png
	...
	const renderInputForm = () => {
		...
		return (
			<div className="form-container">
				...
				<input type="text" value={record} placeholder="whats ur karma power?" onChange={(e) => setRecord(e.target.value)} />
				{editing ? (
